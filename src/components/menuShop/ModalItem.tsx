              ...
              >
                {(formik) => (
                  <Form noValidate className="">
                        ...
                        if (type === 'originals') {
                          return (
                            <div
                              ...
                              key={name}
                              className=" flex items-center pl-4 border border-red-200 rounded dark:border-red-700"
                            >
                              <label className="cursor-pointer w-full py-4 ml-2 text-3xl font-medium text-red-900 dark:text-red-300">
                                <Field
                                  className="w-8 h-8 text-red-600 bg-red-100 border-red-300 rounded focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-red-800 focus:ring-2 dark:bg-red-700 dark:border-red-600"
                                  type="checkbox"
                                  name="toppings"
                                  value={name}
                                />
                    ...
                    <div className=" w-full p-6 border-t border-solid border-blueGray-200 rounded-b">
                      <div className="flex justify-around w-full">
                        <div className="flex items-center">
                          <button
                            className="w-24 h-24 border border-red-500 rounded-full text-red-500 p-2 text-8xl"
                            type="button"
                            onClick={() =>
                          ...
                          <Field
                            ...
                            name="quantity"
                            min="1"
                            className="w-24 h-24 text-center border border-gray-400 rounded p-2 text-8xl"
                          />
                          <button
                            className="w-24 h-24 border border-emerald-500 rounded-full text-emerald-500 p-2 text-8xl"
                            type="button"
                            onClick={() =>
                              formik.setFieldValue(
                                'quantity',
