  ...
  return (
    <div className="bg-gray-50 p-4 rounded-lg">
        ...
        {materials.map((material, index) => (
          ...
          >
            <div>
              ...
              <span className="text-gray-400  ml-2">({material.unit})</span>
            </div>
            <div className="text-right">
              <div>
                Stock: {material.stock.toFixed(2)} {material.unit}
              </div>
              <div>
                Costo: ${material.costo} por {material.unidadPorPrecio}{" "}
                {material.unit}
              </div>
              <div className="text-xs text-gray-400 ">
                Costo unitario: $
                {(material.costo / material.unidadPorPrecio).toFixed(2)} por{" "}
                {material.unit}
              </div>
            </div>
          </div>
      ...
      <div className="mt-4 text-xs text-gray-400 ">
        * Los costos mostrados son los registrados en el sistema. Verificar
        regularmente para mantener actualizado.
      </div>
    </div>
  );
};
