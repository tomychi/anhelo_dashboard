	...
	return (
		<div className="font-coolvetica pb-4">
			...
			<p className="text-4xl text-gray-100 text-center  mb-6 text-black font-bold">
				...
				<div className="bg-gray-100 text-black mx-4 h-20  flex items-center text-center justify-center text-2xl rounded-3xl ">
					PROBAR GRATIS
				</div>
			...
			<div className="bg-gray-300 mx-4 flex items-center rounded-3xl py-4"> 
				...
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-36">
