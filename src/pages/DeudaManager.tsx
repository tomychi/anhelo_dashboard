...
const InversionModal: React.FC<InversionModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      <div
        className={`absolute inset-0 bg-black transition-opacity backdrop-blur-sm duration-300 ${
        ...
        <form onSubmit={handleSubmit} className="space-y-2 font-coolvetica">
                ...
                {isNewInvestor ? (
                  <div>
                    <input
                      ...
                      className=" block w-full h-10 rounded-md bg-gray-200 px-4 shadow-sm  text-sm"
                      required
                    />
                  </div>
                ) : (
                  <div>
                    <select
                      ...
                      className=" block w-full h-10 rounded-md bg-gray-200 px-4 appearance-none shadow-sm  text-sm"
                      required
                    >
          ...
          <div>
            <select
              ...
              className=" block w-full h-10 rounded-md bg-gray-200 px-4 shadow-sm  text-sm appearance-none"
              required
            >
          ...
          <div>
            <input
              ...
              className="block w-full h-10 rounded-md bg-gray-200 px-4 shadow-sm text-sm [&::-webkit-calendar-picker-indicator]:invert-[0.8]"
              required
            />
          </div>
...
const InvestorGroup: React.FC<{
  ...
  const totalByCurrency = sortedInvestments.reduce(
    (acc, inv) => {
...
export const DeudaManager: React.FC = () => {
  ...
  return (
    <div className="flex flex-col">
      <div className="flex flex-row justify-between font-coolvetica items-center mt-8 mx-4 mb-8">
