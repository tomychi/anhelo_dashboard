			...
			<div>
				...
				<div className="grid grid-cols-4 gap-4">
					<div className="flex flex-col">
						...
						<div className="w-full bg-black shadow-black rounded-lg h-min font-coolvetica  shadow-lg p-4 mb-4  ">
							{grupoManual.length > 0 && (
								<div className="flex flex-col gap-2">
									{pedidosReserva.length > 0 && (
										<div className="bg-black shadow-black h-min font-coolvetica w-full shadow-lg   rounded-lg">
											<h3 className="font-medium text-gray-100 mt-4 mb-8 text-center">
												Reservas
											</h3>
											<div className="flex flex-col gap-2">
													...
													>
														...
														<div className="relative">
															<svg
																...
																className="h-5 pr-4 opacity-50 cursor-pointer"
																onMouseEnter={() =>
															...
															{tooltipVisibility[`reserva-${index}`] && (
																<div className="absolute z-50 px-3 py-2 font-light text-white bg-black rounded-lg shadow-sm tooltip text-xs bottom-full left-1/2 transform -translate-x-1/2 mb-2 whitespace-nowrap flex flex-row items-center gap-2">
																	<svg
																		xmlns="http://www.w3.org/2000/svg"
																		version="1.0"
																		width="20"
