...
export const Comandera = () => {
  ...
  // console.log(orders);
  // Filtrar los objetos que no tienen "llamarROTADOR" en la propiedad "cadete"
  const OrdersSinRotadores = orders.filter(
    (order) =>
      order.cadete &&
      typeof order.cadete === 'string' &&
      order.cadete.toLowerCase() !== 'llamarrotador'
  );

  console.log(OrdersSinRotadores);
