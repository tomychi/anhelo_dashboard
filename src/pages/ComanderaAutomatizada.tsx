...
import {
  listenToActiveCadetes,
  updateCadetRecorridos,
  updateCadetAvailability,
  findCadetPhoneByName,
} from "../firebase/comandera2025";
...
export const ComanderaAutomatizada: React.FC = () => {
  ...
  const handleClearMessage = async () => {
    try {
      await updateAltaDemandaMessage("");
              ...
              {(grupoManual.length > 0 || pedidosReserva.length > 0) && (
                <div className="flex flex-col">
                  {grupoManual.length > 0 && (
                    <div className="bg-gray-200 shadow-gray-400 h-min font-coolvetica w-full shadow-lg  p-4 mb-4 rounded-lg">
                  ...
                  <div className="flex flex-col gap-2">
                    {pedidosReserva.length > 0 && (
                      <div className="bg-gray-200 shadow-gray-400 rounded-lg p-4 mb-4 h-min font-coolvetica w-full shadow-lg">
                        <h3 className="font-medium text-black mt-4 mb-8 text-center">
                          Reservas
                        </h3>
                        <div className="flex flex-col gap-2">
                  ...
                  >
                    {(provided) => (
                      <div
                        {...provided.droppableProps}
                        ref={provided.innerRef}
                        className="bg-gray-200 shadow-gray-400 h-min font-coolvetica w-full shadow-lg p-4 mb-4 rounded-lg"
                      >
                        ...
                        <div className="flex flex-col items-center justify-between w-full mt-2 mb-2 gap-2">
                          ...
                          <PhoneNumberInput
                            ...
                            onAssign={(cadete) =>
                              handleAsignarCadete(index, cadete, true)
                            }
