...
export const CampañaDetalle: React.FC = () => {
  ...
  const [estadisticas, setEstadisticas] = useState<{
    ...
    estadisticasClientes: {
      ...
      clientesQuePrimeraVez: number;
      clientesRecurrentes: number;
      clientesQueVolvieron: number;
      tasaRetorno: number;
      tasaClientesRecurrentes: number;
    };
  }>({
    totalPedidos: 0,
    totalCupones: 0,
    ...
    estadisticasClientes: {
      totalClientes: 0,
      clientesConCupon: 0,
      clientesQuePrimeraVez: 0,
      clientesRecurrentes: 0,
      clientesQueVolvieron: 0,
      tasaRetorno: 0,
      tasaClientesRecurrentes: 0,
    },
  });
    ...
    const cargarPedidos = async () => {
      ...
      try {
        const { todosPedidos, pedidosConCupon, codigosCampana } =
          await obtenerPedidosDesdeCampana(
            campaignData.fecha,
            campaignData.titulo
          );
    ...
    <div className="container mx-auto px-4 py-8 font-coolvetica">
        ...
        <div className="mb-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-lg font-medium">
                {estadisticas.estadisticasClientes.totalClientesUnicos}
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-lg font-medium">
                {estadisticas.estadisticasClientes.recurrentesNoVolvieron}
              </p>
            </div>
            <div>
              <p className="text-sm text-gray-500">
              ...
              <p className="text-lg font-medium">
                {estadisticas.estadisticasClientes.recurrentesVolvieron}
              </p>
            </div>
            <div>
      ...
      <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
        <div className="mb-4">
          ...
          <h2 className="font-bold mb-4">
            Monto por nuevos volviendo a comprar: ACAAA
          </h2>
          <div className="flex gap-4 mb-4">
            <input
              type="text"
              className="flex-1 bg-gray-100 rounded-md px-3 py-2 border border-gray-200 "
              value={newCostTitle}
            ...
            <input
              type="number"
              className="w-32 bg-gray-100 rounded-md px-3 py-2 border border-gray-200 "
              value={newCostValue}
