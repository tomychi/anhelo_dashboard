...
export const Dashboard = () => {
	...
	useEffect(() => {
		const getOrdersData = () => {
			ReadDataForDateRange<PedidoProps>("pedidos", valueDate, (pedidos) => {
		...
		getOrdersData(); // Llama a la función al principio del efecto

		// Agrega getOrdersData a la lista de dependencias
		// Esto garantiza que el efecto se ejecute nuevamente si getOrdersData cambia
	}, [valueDate]);
